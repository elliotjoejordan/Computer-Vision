...
master_path_to_dataset = ""; # ** need to edit this **
...
DATA_WINDOW_OFFSET_FOR_TRAINING_SAMPLES = 5;
...
HOG_SVM_PATH = "svm_hog_RBF.xml"

HOG_SVM_kernel = cv2.ml.SVM_RBF; # see opencv manual for other options
HOG_SVM_max_training_iterations = 100; # stop training after max iterations
